  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "parameterAliasIdentifier": parse_parameterAliasIdentifier,
        ...
        "exp": parse_exp,
        "parameterAliasExpr": parse_parameterAliasExpr,
        "parameterAliasValue": parse_parameterAliasValue,
        "query": parse_query,
      ...
      function parse_parameterAliasIdentifier() {
        var result0, result1;
        var pos0, pos1;
      ...
      function parse_identifierRoot() {
        ...
        result0 = parse_parameterAliasIdentifier();
        if (result0 === null) {
          pos0 = pos;
          pos1 = pos;
      ...
      function parse_exp() {
        ...
        result0 = parse_parameterAliasExpr();
        if (result0 === null) {
          result0 = parse_expand();
          if (result0 === null) {
            result0 = parse_apply();
      ...
      function parse_parameterAliasExpr() {
        var result0, result1, result2;
        var pos0, pos1;
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            result2 = parse_parameterAliasValue();
            if (result2 !== null) {
              result0 = [result0, result1, result2];
            } else {
              result0 = null;
      ...
      function parse_parameterAliasValue() {
        var result0;
